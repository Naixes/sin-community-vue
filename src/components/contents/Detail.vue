        ...
        <div class="fly-panel detail-box">
          ...
          <div class="detail-about">
            <a class="fly-avatar" href="../user/home.html">
              <img :src="page.uid?page.uid.avatar: '/img/bear-200-200.jpg'" />
            </a>
            ...
            <li class="jieda-daan" v-for="(item,index) in comments" :key="'commments' + index">
              <div class="detail-about detail-about-reply">
                <a class="fly-avatar" href>
                  <img :src="item.cuid ? item.cuid.avatar : '/img/bear-200-200.jpg'" alt=" " />
                </a>
                <div class="fly-detail-user">
                  <router-link
                    class="fly-link"
            ...
            <form>
              <validation-observer ref="observer" v-slot="{ validate }">
                ...
                <div class="layui-form-item">
                  ...
                  >
                    <div class="layui-row">
                      <label for="L_vercaptcha" class="layui-form-label">验证码</label>
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      this.editInfo.captcha = this.captcha
